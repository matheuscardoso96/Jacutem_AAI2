...
namespace Jacutem_AAI2.Imagens
{
    public class Ncgr
    {
        ...
        public int QuatidadeCores { get; set; }
        ...
        public Ncgr(string dirNcgr)
        {

        }

        public Ncgr(string dirNcgr, Nscr nscr, Nclr nclr)
        {
            ArquivoNscr = nscr;
            ArquivoNclr = nclr;
        ...
        public Ncgr(string dirNcgr, Ncer ncer, Nclr nclr)
        {
            ArquivoNcer = ncer;
            ArquivoNclr = nclr;
        }
